...
var _TicTacToe = __webpack_require__(27);
...
function main() {
	var element = _react2.default.createElement(_TicTacToe2.default, null);
...
var _GridSquare = __webpack_require__(28);

var _GridSquare2 = _interopRequireDefault(_GridSquare);

var _ResetButton = __webpack_require__(29);
...
var TicTacToe = function (_React$Component) {
	...
	function TicTacToe(props) {
		...
		_this.findWinner = _this.findWinner.bind(_this);
	...
	_createClass(TicTacToe, [{
		...
		value: function findWinner() {
			var blackP = this.state.black;
			var whiteP = this.state.white;
			if ((blackP & 7) == 7 || (blackP & 56) == 56 || (blackP & 448) == 448 || (blackP & 73) == 73 || (blackP & 146) == 146 || (blackP & 292) == 292 || (blackP & 273) == 273 || (blackP & 84) == 84) return 0;else if ((whiteP & 7) == 7 || (whiteP & 56) == 56 || (whiteP & 448) == 448 || (whiteP & 73) == 73 || (whiteP & 146) == 146 || (whiteP & 292) == 292 || (whiteP & 273) == 273 || (whiteP & 84) == 84) return 1;else return -1;
		}
	}, {
		key: 'createButton',
		value: function createButton(position) {
			var _this2 = this;

			var buttonText = " ";
			var clickFunction = function clickFunction() {
				if (_this2.state.sideToMove == 0) _this2.setState({
					black: _this2.state.black | 1 << position,
					white: _this2.state.white,
					sideToMove: 1
				});else _this2.setState({
					black: _this2.state.black,
					white: _this2.state.white | 1 << position,
					sideToMove: 0
				});
			};
			if ((this.state.black & 1 << position) > 0) {
				...
				buttonText = "O";
				clickFunction = function clickFunction() {};
			} else if (this.findWinner() != -1) clickFunction = function clickFunction() {};
			return _react2.default.createElement(_GridSquare2.default, {
				text: buttonText,
		...
		value: function render() {
			...
			var stateText = "";
			if (this.findWinner() == 0) stateText = "Game over: X wins!";else if (this.findWinner() == 1) stateText = "Game over: O wins!";else if ((this.state.black | this.state.white) == 511) stateText = "Tie game!";else {
				if (this.state.sideToMove == 0) stateText = "X's move";else stateText = "O's move";
			}
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_ResetButton2.default, { callback: function callback() {
						_this3.setState({ black: 0, white: 0, sideToMove: 0 });
					} }),
...
var GridSquare = function GridSquare(_ref) {
	var text = _ref.text,
...
var ResetButton = function ResetButton(callback) {
	return _react2.default.createElement(
		'button',
		{ onClick: function onClick() {
				return callback();
